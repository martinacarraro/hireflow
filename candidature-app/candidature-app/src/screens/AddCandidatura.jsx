    ...
    <div className="screen">
      ...
      <div className="flex items-center gap-3 px-5 pt-safe pt-4 pb-3 border-b border-border flex-shrink-0">
        ...
        <div>
          ...
          <p className="text-xs text-muted italic">Hai un link? Incollalo per prima cosa.</p>
        </div>
      </div>
        ...
        <div className="card mb-5 border-purple/30">
          ...
          {parseFailed && (
            <p className="text-xs text-muted mt-1.5">
              Non riesco ad estrarre i dati — compilali tu qui sotto 😊
            </p>
          )}
        </div>
